...
const FILES = ['core', 'geometry', 'source', 'engine', 'state', 'solver', 'modeA', 'solvers', 'solver-spoke', 'modeB', 'feasibility', 'photometry', 'profile', 'lenses', 'controller', 'history', 'checks1', 'checks2', 'checks3'];
function load(extra) {
