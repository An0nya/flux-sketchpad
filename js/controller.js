...
(function (root) {
  ...
  const CONTROLS = [
    ...
    num('tgt.res', 'Grid', (s) => TG(s).res, (s, v) => setResolution(s, Math.round(RF.U.clamp(v, 10, 100))), { section: 'heatmap', min: 10, max: 100, step: 1, help: 'Accumulator / paint grid N×N (default 50, up to 100).' }),
    // ---- Mode A
